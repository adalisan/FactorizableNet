...
def proposal_target_layer(object_rois, gt_objects, gt_relationships, n_classes_obj, is_training):
    ...
    if is_training:
        ...
        object_labels, object_rois, bbox_targets, bbox_inside_weights, \
            phrase_labels, phrase_rois, \
                mat_object, mat_phrase = _sample_rois(all_rois, \
                    gt_objects, gt_relationships, 1, n_classes_obj, is_training)
        ...
        object_labels, bbox_targets, bbox_inside_weights, bbox_outside_weights, phrase_labels = [None] * 5
...
def _sample_rois(object_rois, gt_objects, gt_relationships, num_images, num_classes, is_training):
