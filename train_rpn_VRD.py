...
## training settings
parser.add_argument('--path_data_opts', type=str, default='options/data_VRD.yaml', help='Use options for ' )
...
parser.add_argument('--path_rpn_opts', type=str, default='options/RPN/RPN_FN_VRD.yaml', help='Path to RPN opts')
